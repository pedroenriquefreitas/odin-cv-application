...
function Contact({nameStateFunction, emailStateFunction,
   phoneStateFunction, status, submitSetter}){
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    nameStateFunction(name);
    emailStateFunction(email);
    phoneStateFunction(phone);
    submitSetter();
  }
